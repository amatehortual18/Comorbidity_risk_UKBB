...
file_ukbb='ukb669914.csv'   # ukb669914.csv   ukb669914.csv
...
# to save
save_Diabetes2CVD_c=folderRoot+'/data/Diabetes2CVD_class.csv'
save_CVD2Diabetes_c=folderRoot+'/data/CVD2Diabetes_class.csv'
save_Depre2CVD_c=folderRoot+'/data/Depre2CVD_class.csv'
save_CVD2Depre_c=folderRoot+'/data/CVD2Depre_class.csv'

save_onlyCVD_c=folderRoot+'/data/HealthyvsCVD_class.csv'
save_onlyDepre_c=folderRoot+'/data/HealthyvsDepre_class.csv'
all_data=folderRoot+'/data/all_data_v.csv'
save_onlyDiabetes_c=folderRoot+'/data/HealthyvsDiabetes_class.csv'
...
save_file_U1ind=folderRoot+'data/allindividuals_'+file_ukbb
...
file_output1=folderRoot+'data/'+'filter_'+file_ukbb
